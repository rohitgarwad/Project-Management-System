...
export const SEND_ISSUE_REPORT_REQUEST = "SEND_ISSUE_REPORT_REQUEST";
export const SEND_ISSUE_REPORT_SUCCESS = "SEND_ISSUE_REPORT_SUCCESS";
export const SEND_ISSUE_REPORT_FAILURE = "SEND_ISSUE_REPORT_FAILURE";
