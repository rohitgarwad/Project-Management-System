...
const ProjectReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    case actionTypes.FETCH_ALL_USERS_PROJECT_ROLES_REQUEST:
    case actionTypes.FETCH_USER_PROJECT_ROLE_REQUEST:
    case actionTypes.UPDATE_USERS_PROJECT_ROLE_REQUEST:
      return {
        ...state,
        loading: true,
        error: null,
    ...
    case actionTypes.FETCH_ALL_USERS_PROJECT_ROLES_SUCCESS:
      return {
        ...state,
        loading: false,
        projectRoles: action.projectRoles,
      };
    case actionTypes.FETCH_USER_PROJECT_ROLE_SUCCESS:
      return {
        ...state,
        loading: false,
        userProjectRole: action.userProjectRole,
      };
    case actionTypes.UPDATE_USERS_PROJECT_ROLE_SUCCESS:
      return {
        ...state,
        loading: false,
    ...
    case actionTypes.FETCH_ALL_USERS_PROJECT_ROLES_FAILURE:
    case actionTypes.FETCH_USER_PROJECT_ROLE_FAILURE:
    case actionTypes.UPDATE_USERS_PROJECT_ROLE_FAILURE:
      return {
        ...state,
        loading: false,
        error: action.error,
